/**
 * Filename: ContentGenerateResponse.java
 *
...
@AllArgsConstructor
@NoArgsConstructor
public class ContentGenerateResponse extends BaseResponse {
    private ContentGenerateResponseDTO contentGenerateResponseDTO;
