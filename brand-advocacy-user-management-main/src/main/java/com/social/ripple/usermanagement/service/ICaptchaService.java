/**
 * Filename: ICaptchaService.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual property
...
public interface ICaptchaService {
	public RecaptchaResponse verifyToken(String traceId,String captchaToken); 
}
