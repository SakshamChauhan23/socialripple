/**
 * Filename: MediaLibraryResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
@Getter
@Setter
public class MediaLibraryResponse extends BaseResponse {

	private List<MediaLibraryDto> mediaLibrary;
