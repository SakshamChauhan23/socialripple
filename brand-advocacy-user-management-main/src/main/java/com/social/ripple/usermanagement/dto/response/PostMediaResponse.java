/**
 * Filename: PostMediaResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public class PostMediaResponse extends BaseResponse {
	private PostResponse postMediaResponseData;
	public PostMediaResponse(boolean status, String code, String message, String devMessage, Date timestamp, PostResponse mediaPostData) {
		super.setStatus(status);
		super.setCode(code);
		super.setMessage(message);
		super.setDevMessage(devMessage);
		super.setTimestamp(timestamp);
		this.postMediaResponseData = mediaPostData;
	}
}
