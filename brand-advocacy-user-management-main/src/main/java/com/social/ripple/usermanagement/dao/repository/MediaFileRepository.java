/**
 * Filename: MediaFileRepository.java
 *
...
public interface MediaFileRepository extends JpaRepository<MediaFile, Long>{
	...
	Optional<MediaFile> findByOrganizationIdAndFileUrl(Long organizationId, String fileUrl);

	List<MediaFile> findByOrganizationIdAndFileUrlIn(Long organizationId, List<String> fileUrls);
