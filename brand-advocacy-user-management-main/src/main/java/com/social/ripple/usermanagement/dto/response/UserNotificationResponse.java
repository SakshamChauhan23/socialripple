 ...
 * Filename: UserNotificationResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public class UserNotificationResponse extends BaseResponse {
	private List<NotificationResponseDto> notificationData;
