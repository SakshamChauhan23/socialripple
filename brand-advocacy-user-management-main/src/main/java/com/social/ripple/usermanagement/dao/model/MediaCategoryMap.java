/**
 * Filename: MediaCategoryMap.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual property
...
@Entity
@Table(name = "media_category_map")
@Getter
@Setter
public class MediaCategoryMap {
