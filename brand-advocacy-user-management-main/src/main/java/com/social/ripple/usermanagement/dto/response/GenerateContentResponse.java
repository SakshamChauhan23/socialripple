/**
 * Filename: GenerateContentResponse.java
 *
...
@AllArgsConstructor
@NoArgsConstructor
public class GenerateContentResponse extends BaseResponse {
    private GenerateContentResponseDTO generateContentResponseDTO;
}
