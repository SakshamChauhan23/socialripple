/**
 * Filename: MediaResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual property
...
public class MediaResponse extends BaseResponse {
	private List<PostResponseDto> postData;
	private List<PostHashtagsDto> hashTags;
	private List<MediaPostDto> mediaPostDto;
	private List<PostTagDto> postTag;
	private List<PostCategoryMapDto> postCategory;
