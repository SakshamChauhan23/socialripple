/**
 * Filename: ProfileConstants.java
 *
...
public class ProfileConstants {
    ...
    public static final int MAX_PROFILE_PICTURE_LENGTH = 255;
    ...
    public static final String INVALID_NAME_LENGTH = "Name must be less than " + MAX_NAME_LENGTH + " characters";
    public static final String INVALID_PROFILE_PICTURE_LENGTH = "Profile picture URL must be less than " + MAX_PROFILE_PICTURE_LENGTH + " characters";
}
