/**
 * Filename: InviteUserService.java
 *
...
public interface IInviteUserService {
	...
	ResponseEntity<InviteUserResponse> inviteUser(InviteUserRequest request, String tenantId, String traceId);

    ResponseEntity<InviteUserResponse> reinviteUser(ReinviteUserRequest request, String tenantId, String traceId);

    ResponseEntity<BaseResponse> updateUser(InviteUserRequest request, String tenantId, String traceId);
    ResponseEntity<BaseResponse> toggleAdminRole(UserAdminToggleRequest request, String tenantId, String traceId);
}
