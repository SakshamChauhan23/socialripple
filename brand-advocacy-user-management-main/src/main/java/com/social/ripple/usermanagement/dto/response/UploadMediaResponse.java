/**
 * Filename: UploadMediaResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public class UploadMediaResponse extends BaseResponse {
    ...
    public UploadMediaResponse(boolean status, String code, String message, String devMessage, Date timestamp,
