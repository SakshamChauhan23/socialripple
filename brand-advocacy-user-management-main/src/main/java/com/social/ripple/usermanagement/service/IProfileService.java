...
public interface IProfileService {
	ProfileDataResponse viewProfile(String traceId, Long userId, UserDetailsImpl detailsImpl);
    BaseResponse updateProfile(String traceId, ProfileRequestDTO request, UserDetailsImpl userDetails);
}
