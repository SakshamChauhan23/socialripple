...
public interface TrendingHashtagsRepository extends JpaRepository<TrendingHashtags, Long> {
	Optional<TrendingHashtags> findFirstByHashtagsIsNotNullOrderByUpdatedAtDesc();

	Optional<TrendingHashtags> findFirstByTopicsIsNotNullOrderByUpdatedAtDesc();
}
