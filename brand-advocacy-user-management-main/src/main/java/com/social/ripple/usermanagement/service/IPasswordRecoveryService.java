/**
 * Filename: IPasswordRecoveryService.java
 *
...
public interface IPasswordRecoveryService {
	ForgetPasswordResponse forgetpasword(String xTraceId,String xCorrelationId,
			String tenantId,String languageId, ForgetPasswordRequest forgetPasswordRequest);
	ResetPasswordResponse resetpasword(String xTraceId,String xCorrelationId,
			String tenantId,String languageId,ResetPasswordRequest passwordRequest);
