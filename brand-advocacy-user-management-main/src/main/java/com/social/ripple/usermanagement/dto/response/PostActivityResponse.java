/**
 * Filename: PostActivityResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
@NoArgsConstructor
@AllArgsConstructor
public class PostActivityResponse extends BaseResponse {
	private List<PostActivityDto> activitiesPost;
