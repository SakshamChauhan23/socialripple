/**
 * Filename: ILoyaltyPointsService.java
 *
...
public interface ILoyaltyPointsService {
	LoyaltyResponse getTotalLoyaltyPointsCount(String traceId, String tenantId, String correlationId, String languageId, UserDetailsImpl detailsImpl, Long userId);
}
