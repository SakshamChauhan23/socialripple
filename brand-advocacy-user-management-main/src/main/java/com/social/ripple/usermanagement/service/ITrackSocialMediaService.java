/**
 * Filename: ITrackSocialMediaService.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public interface ITrackSocialMediaService {
	public BaseResponse trackSocialMediaConnection(String traceId, String tenanatId, UserDetailsImpl userDetails, Long userId,boolean isSelf);
