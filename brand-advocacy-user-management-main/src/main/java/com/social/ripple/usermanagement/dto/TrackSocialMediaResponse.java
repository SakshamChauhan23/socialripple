/**
 * Filename: TrackSocialMediaResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
@Getter
@Setter
public class TrackSocialMediaResponse extends BaseResponse {

	private List<TrackSocialMediaDto> socialMediaConnectionData;
