/**
 * Filename: SsoProviderResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
@Getter
@Setter
public class SsoProviderResponse extends BaseResponse {
	private List<SsoProviderDto> providerData;
}
