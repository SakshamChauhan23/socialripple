/**
 * Filename: ISsoTokenValidatorService.java
 *
...
public interface ISsoTokenValidatorService {

	  public  GoogleUserDto validateGoogleSsoToken(String traceId,String idToken);
