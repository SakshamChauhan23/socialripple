/**
 * Filename: SsoProviderDto.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual property
...
public class SsoProviderDto {
	...
	public SsoProviderDto(Long id, String name) {
		this.providerId = id;
