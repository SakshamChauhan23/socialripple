/**
 * Filename: SocialMediaConnection.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public enum SocialMediaConnection {
	NEVER_CONNECTED, CONNECTED, EXPIRED
}
