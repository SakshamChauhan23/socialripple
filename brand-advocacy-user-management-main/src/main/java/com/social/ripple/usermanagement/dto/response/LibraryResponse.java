/**
 * Filename: LibraryResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual property
...
public class LibraryResponse extends BaseResponse {
	...
	private List<LibraryDto> mediaLibrary;
	private int page;
	private int size;
