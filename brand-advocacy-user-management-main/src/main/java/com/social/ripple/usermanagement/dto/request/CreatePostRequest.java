/**
 * Filename: CreatePostRequest.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public class CreatePostRequest {
	...
	private List<Long> libraryMediaIds;

	private List<Long> taggedUserIds;
	
	private List<Long> categories;

	@JsonProperty("xGeneratedContent")
	private String xGeneratedContent;

	@JsonProperty("xHashtags")
