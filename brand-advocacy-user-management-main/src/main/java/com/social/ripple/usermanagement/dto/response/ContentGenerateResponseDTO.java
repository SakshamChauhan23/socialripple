/**
 * Filename: ContentGenerateResponseDTO.java
 *
...
@Setter
@NoArgsConstructor
public class ContentGenerateResponseDTO {
    private String generatedText;
    private String xGeneratedContent;
    private String xHashtags;
    private boolean truncated;

    public ContentGenerateResponseDTO(String generatedText, String xGeneratedContent) {
        this.generatedText = generatedText;
        this.xGeneratedContent = xGeneratedContent;
    }

    public ContentGenerateResponseDTO(String generatedText, String xGeneratedContent, String xHashtags) {
        this.generatedText = generatedText;
        this.xGeneratedContent = xGeneratedContent;
        this.xHashtags = xHashtags;
    }
}
