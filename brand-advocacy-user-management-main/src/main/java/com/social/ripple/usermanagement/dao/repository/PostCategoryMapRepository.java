/**
 * Filename: PostCategoryMapRepository.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public interface PostCategoryMapRepository extends JpaRepository<PostCategoryMap, Long> {

	@Query("SELECT c FROM PostCategoryMap c WHERE c.postId IN :postIds")
	List<PostCategoryMap> findByPostIds(@Param("postIds") List<Long> postIds);
