...
public interface IArchiveService {
	ArchiveResponse archiveMedia(String xTraceId,String xCorrelationId,
			String tenantId,String languageId,UserDetailsImpl detailsImpl,Long mediaId);

	ArchiveResponse restoreMedia(String xTraceId,String xCorrelationId,
			String tenantId,String languageId,UserDetailsImpl detailsImpl,Long mediaId);
