...
public interface ICategoryService {
	CategoryResponse createCategory(String traceId, String correlationId, String tenantId, String languageId,
			CategoryRequestDTO request, UserDetailsImpl detailsImpl);

	CategoryResponse updateCategory(String traceId, String correlationId, String tenantId, String languageId, Long id,
			CategoryRequestDTO request, UserDetailsImpl detailsImpl);

	CategoryResponse getAllCategories(String traceId, String correlationId, String tenantId, String languageId, Long id,
			UserDetailsImpl detailsImpl);

	CategoryResponse deleteCategory(String traceId, String correlationId, String tenantId, String languageId, Long id,
			UserDetailsImpl detailsImpl);

	AssignCategoryResponse assignCategoryToPost(String traceId, String correlationId, String tenantId, String languageId,
			Long postId, AssignCategoryRequest request, UserDetailsImpl detailsImpl);
}
