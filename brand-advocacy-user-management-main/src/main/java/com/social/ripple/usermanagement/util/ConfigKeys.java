...
public final class ConfigKeys {
	...
	public static final String BUNNY_STREAM_LIBRARY_ID = "BUNNY_STREAM_LIBRARY_ID";
	public static final String BUNNY_STREAM_API_KEY = "BUNNY_STREAM_API_KEY";
	public static final String BUNNY_STREAM_PLAYBACK_BASE_URL = "BUNNY_STREAM_PLAYBACK_BASE_URL";
	public static final String BUNNY_STREAM_THUMBNAIL_BASE_URL = "BUNNY_STREAM_THUMBNAIL_BASE_URL";

	public static final String GEMINI_API_KEY = "GEMINI_API_KEY";
	public static final String GEMINI_API_URL = "GEMINI_API_URL";

	// NewsAPI (trending topics). Optional — feature degrades gracefully when missing.
	public static final String NEWSAPI_API_KEY = "NEWSAPI_API_KEY";
	public static final String NEWSAPI_BASE_URL = "NEWSAPI_BASE_URL";
}
