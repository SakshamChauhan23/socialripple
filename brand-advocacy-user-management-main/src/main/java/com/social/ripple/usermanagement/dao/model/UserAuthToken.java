...
public class UserAuthToken {
	...
	private Platform platform; // enum-based platform

	@Column(name = "user_id_external", length = 50)
	private String userIdExternal; // external user id
	...
	private String status = "NEVER_CONNECTED";

	@Column(name = "is_connected", nullable = false)
	private Boolean isConnected = false;

	@Column(name = "transaction_id", length = 255, unique = true)
	private String transactionId; // replaces previous 'state' field
