/**
 * Filename: PostHashtag.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual property
...
public class PostHashtag {
	...
	@Column(name = "hash_tag", nullable = false, length = 200)
