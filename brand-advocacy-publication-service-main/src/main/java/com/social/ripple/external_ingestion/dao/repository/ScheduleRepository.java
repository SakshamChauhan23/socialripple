...
import com.social.ripple.external_ingestion.dao.model.Schedule;
...
public interface ScheduleRepository extends JpaRepository<Schedule, Long>{
    List<Schedule> findByUserIdAndTenantId(Long userId, Long tenantId);

    Optional<Schedule> findByIdAndTenantId(Long scheduleId, Long tenantId);

    Optional<Schedule> findByIdAndTenantIdAndIsProcessedFalse(Long scheduleId, Long tenantId);

    List<Schedule> findByScheduledTimeUtcBeforeAndIsProcessedFalse(LocalDateTime currentTime);
}
