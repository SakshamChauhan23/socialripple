/**
 * Filename: ActivityShareResponse.java © Copyright 2024 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public class DashboardResponse extends BaseResponse {
	private List<MonthlyParticipationDTO> monthlyReachCount;
	private LeadConversionDTO xLead;
	private LeadConversionDTO linkedinLead;
	private LeadConversionDTO facebookLead;
	private LeadConversionDTO instagramLead;
}
