...
public interface ExternalShareRepository extends JpaRepository<ExternalShare, Long> {
	...
	ExternalShare findByUserIdAndPostIdAndPlatform(Long userId, Long postId, String platform);

	List<ExternalShare> findByUserIdAndPostId(Long userId, Long postId);

	List<ExternalShare> findByPostId(Long postId);

	List<ExternalShare> findByTenantId(Long tenantId);
}
