/**
 * Filename: GenerateContentResponseDTO.java
 *
...
public class LeadConversionDTO {
    private Integer leadCount; // unique users
    private Integer conversionCount; // click count
    private Double conversionPercentage; // .01 * conversionCount / leadCount
}
