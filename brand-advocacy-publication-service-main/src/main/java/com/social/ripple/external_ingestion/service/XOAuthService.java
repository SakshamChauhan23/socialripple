...
public interface XOAuthService {
	...
	String getAuthorizationUrl(String callbackUrl, HttpSession session) throws Exception;

    UserAuthToken saveUserTokens(String externalUserId, String accessToken, String accessSecret);

    Post getPostById(Long postId);
    
    TweetResponse postTweetWithUploadedFile(TweetRequest request) throws Exception;
    
    UserAuthToken handleCallback(String oauthVerifier, HttpSession session) throws Exception;
