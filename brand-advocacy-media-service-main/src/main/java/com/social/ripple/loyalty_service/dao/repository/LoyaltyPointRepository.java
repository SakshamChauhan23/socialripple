/**
 * Filename: LoyaltyPointRepository.java
 *
...
import com.social.ripple.loyalty_service.dao.model.LoyaltyPoint;
...
public interface LoyaltyPointRepository extends JpaRepository<LoyaltyPoint, Long> {
	...
	Optional<LoyaltyPoint> findByUserIdAndWallet(Long userId, Wallet wallet);
