...
SOURCE_DIR="/github/prod/media-service"
APP_DIR="/opt/advocacy/media-service-prod"
UNIT_NAME="advocacy-media-service-prod.service"
...
MAX_SMOKE_ATTEMPTS="${MAX_SMOKE_ATTEMPTS:-25}"
